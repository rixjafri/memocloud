//
//  PicturePreviewVC.swift
//  JJSystems
//
//  Created by Rizwan Shah on 04/12/2024.
//
...
class PicturePreviewVC:UIViewController {
    
    // load a lower resolution images
    var images:[UIImage] = pictureData.images.compactMap {
...
extension PicturePreviewVC:UICollectionViewDataSource {
